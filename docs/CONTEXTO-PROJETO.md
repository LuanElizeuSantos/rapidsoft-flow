# Consistem Flow — contexto do projeto
...
Editor de fluxogramas **Consistem Flow / Rapidsoft Flow** (HTML + JS legado + React/Vite no diagrama).
...
- Evento de rebuild: `consistem-flow-change`.
